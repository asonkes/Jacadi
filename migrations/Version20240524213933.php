 ...
 */
final class Version20240524213933 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE products CHANGE created_ad created_ad DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE products CHANGE created_ad created_ad DATETIME NOT NULL');
